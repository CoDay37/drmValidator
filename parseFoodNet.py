...
base_URL = 'http://www.watch.foodnetwork.com/shows'
...
def getVideoSource(site):
        ...
        driver.switch_to_frame('player_418')
        vidLink = driver.find_element_by_id('player_418-video-container').get_attribute('src')
